...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmaboutcmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmaboutcmsblockinfo_lang` il ON il.`id_tmaboutcmsblockinfo` = i.`id_tmaboutcmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmaboutcmsblockinfo->text = reset($customTexts);
