...
{if $data.atccb_product_can_be_ordered}
	...
	{/if}
<div id="atccb_product_cart" class="">
	<form id="atccb_form" method="POST" action="{$smarty.server.REQUEST_URI}">
		<h3 class="title_block atccb_cart_title"><i class="material-icons">stars</i> {l s='Product recommended by' mod='addtocartcheckbox'} {$shop.name}</h3>
