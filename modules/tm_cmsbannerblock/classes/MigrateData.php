...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmcmsbannerblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmcmsbannerblockinfo_lang` il ON il.`id_tmcmsbannerblockinfo` = i.`id_tmcmsbannerblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmcmsbannerblockinfo->text = reset($customTexts);
