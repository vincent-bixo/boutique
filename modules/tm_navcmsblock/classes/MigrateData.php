...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmnavcmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmnavcmsblockinfo_lang` il ON il.`id_tmnavcmsblockinfo` = i.`id_tmnavcmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmnavcmsblockinfo->text = reset($customTexts);
