...
<div class="container">
	<h2 class="h1 products-section-title text-uppercase">
		{l s='Best Seller Item' d='Shop.Theme.Global'}
	</h2>
	<div id="spe_res">
	<div class="products">	
		...
		{foreach from=$products item="product"}
			<li class="{if $slider == 1 && $no_prod >= $sliderFor}item{else}product_item col-xs-12 col-sm-6 col-md-4{/if}">
				{include file="catalog/_partials/miniatures/product.tpl" product=$product}
			</li>
		{/foreach}
		{if $slider == 0}
			<li class="loadmore">
				<div class="tm-message"><i class="material-icons">&#xE811;</i>{l s='No more products found!' d='Modules.Bestsellers'}</div>
				<button class="btn btn-default gridcount btn-primary">{l s='more products' d='Modules.Bestsellers'}</button>
			</li>
		{/if}	
		</ul>
