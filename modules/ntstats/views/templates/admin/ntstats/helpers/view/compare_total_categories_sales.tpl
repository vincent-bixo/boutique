...
<div class="panel-heading">
    <i class="fas fa-balance-scale-right"></i>&nbsp;<span class="tab_name">{l s='Compare total categories sales' mod='ntstats'}</span>
</div>
<div>
    <form>
        <div class="form_grid compare">
            <div class="compare_date">
                <div class="input-group">
                    ...
                    <input type="text" class="datepicker input-medium form-control" name="compare_total_categories_sales_date_from_period1" id="compare_total_categories_sales_date_from_period1"
            ...
            <div class="compare_date">
                <div class="input-group">
                    ...
                    <input type="text" class="datepicker input-medium form-control" name="compare_total_categories_sales_date_to_period1" id="compare_total_categories_sales_date_to_period1"
            ...
            <div class="compare_date">
                <div class="input-group">
                    <span class="input-group-addon">{l s='From' mod='ntstats'}</span>
                    <input type="text" class="datepicker input-medium form-control" name="compare_total_categories_sales_date_from_period2" id="compare_total_categories_sales_date_from_period2"
            ...
            <div class="compare_date">
                <div class="input-group">
                    <span class="input-group-addon">{l s='To' mod='ntstats'}</span>
                    <input type="text" class="datepicker input-medium form-control" name="compare_total_categories_sales_date_to_period2" id="compare_total_categories_sales_date_to_period2"
        ...
        <div class="form_grid">
            <div class="filter_block">
                <select id="compare_total_categories_sales_id_group" name="compare_total_categories_sales_id_group[]"
            ...
            <div class="filter_block">
                <select id="compare_total_categories_sales_id_category" name="compare_total_categories_sales_id_category[]"
            ...
            <div class="filter_block">
                <button type="button" class="btn btn-default filter_btn" id="compare_total_categories_sales_valid" name="compare_total_categories_sales_valid">
                    <i class="fas fa-check"></i>&nbsp;{l s='Filter' mod='ntstats'}
                </button>
            </div>
            <div class="filter_block">
                <button type="button" class="btn btn-default exp_csv_btn" id="compare_total_categories_sales_exp_csv" name="compare_total_categories_sales_exp_csv">
                    <i class="fas fa-file-download"></i>&nbsp;{l s='Export CSV' mod='ntstats'}
                </button>
            </div>
            <div class="filter_block">
                <button type="button" class="btn btn-default exp_xls_btn" id="compare_total_categories_sales_exp_xls" name="compare_total_categories_sales_exp_xls">
                    <i class="fas fa-file-excel"></i>&nbsp;{l s='Export Excel' mod='ntstats'}
                </button>
            </div>
            <input type="hidden" name="type_list" value="compare_total_categories_sales"/>
            <span class="clear"></span>
        </div>
    </form>
    <span class="clear"></span>
    ...
    <div class="stats_data">
        <table id="compare_total_categories_sales" class="data_table" width="100%" data-sorting="true" data-colreorder="true">
            <thead>
                <tr>
        ...
        <div class="data_chart">
            ...
            <div class="canvas_block">
                <canvas id="compare_total_categories_sales_chart" height="560"></canvas>
            </div>
        </div>
    </div>
</div>