...
if((meridiem==='མཚན་མོ'&&hour>=4)||(meridiem==='ཉིན་གུང'&&hour<5)||meridiem==='དགོང་དག'){return hour+12}else{return hour}},meridiem:function(hour,minute,isLower){if(hour<4){return'མཚན་མོ'}else if(hour<10){return'ཞོགས་ཀས'}else if(hour<17){return'ཉིན་གུང'}else if(hour<20){return'དགོང་དག'}else{return'མཚན་མོ'}},week:{dow:0,doy:6}});return bo})))