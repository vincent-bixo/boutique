...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmservicecmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmservicecmsblockinfo_lang` il ON il.`id_tmservicecmsblockinfo` = i.`id_tmservicecmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmservicecmsblockinfo->text = reset($customTexts);
