...
class ProductContextModel
{
    ...
    public static function getFromExpressParams($expressParams, $amount, $currencyIso, $context): self
    {
        ...
        if (!$amount && $psCart->getOrderTotal()) {
            $amount = round($psCart->getOrderTotal(), 2);
