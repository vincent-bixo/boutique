...
class PartialRefundHandler extends InstallOrderStateHandler
{
    public function handle()
    {
        if (!\Configuration::get(\Stripe_official::PARTIAL_REFUND)
            || !\Validate::isLoadedObject(new \OrderState(\Configuration::get(\Stripe_official::PARTIAL_REFUND)))) {
            ...
            \Configuration::updateValue(\Stripe_official::PARTIAL_REFUND, $order_state->id);
        }
    }
}
