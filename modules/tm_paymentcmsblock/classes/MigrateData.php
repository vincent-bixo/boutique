...
class MigrateData
{
    ...
    public function retrieveOldData()
    {
        ...
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'tmpaymentcmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'tmpaymentcmsblockinfo_lang` il ON il.`id_tmpaymentcmsblockinfo` = i.`id_tmpaymentcmsblockinfo`'
        );
    ...
    public function insertData()
    {
        ...
        $tmpaymentcmsblockinfo->text = reset($customTexts);
