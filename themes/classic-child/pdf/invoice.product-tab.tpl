...
<table class="product" width="100%" cellpadding="4" cellspacing="0">
	...
	<thead>
	<tr>
		<th class="product header small" width="17%">{l s='Reference' d='Shop.Pdf' pdf='true'}</th>
		{if isset($layout.before_discount)}
  		<th class="product header small" width="38%">{l s='Product' d='Shop.Pdf' pdf='true'}</th>
    {else}
  		<th class="product header small" width="50%">{l s='Product' d='Shop.Pdf' pdf='true'}</th>
		{/if}
		<th class="product header small" width="7%">{l s='Tax Rate' d='Shop.Pdf' pdf='true'}</th>

		{if isset($layout.before_discount)}
			<th class="product header small" width="12%">{l s='Base price' d='Shop.Pdf' pdf='true'} <br /> {l s='(Tax excl.)' d='Shop.Pdf' pdf='true'}</th>
		{/if}

		<th class="product header-right small" width="12%">{l s='Unit Price' d='Shop.Pdf' pdf='true'} <br /> {l s='(Tax excl.)' d='Shop.Pdf' pdf='true'}</th>
		<th class="product header small" width="6%">{l s='Qty' d='Shop.Pdf' pdf='true'}</th>
		<th class="product header-right small" width="8%">{l s='Total' d='Shop.Pdf' pdf='true'} <br /> {l s='(Tax excl.)' d='Shop.Pdf' pdf='true'}</th>
	</tr>
	</thead>
