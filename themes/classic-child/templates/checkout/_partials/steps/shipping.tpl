          ...
          <div class="order-options">
            ...
            {/if}
              ...
              <span class="custom-checkbox" style="display:none">
                <input class="js-gift-checkbox" id="input_gift" name="gift" type="checkbox" value="1" checked="checked">
              </span>

              <div id="gift" style="display:none">
                <textarea rows="2" cols="120" id="gift_message" name="gift_message">{$smarty.cookies.origine}</textarea>
              </div>
